...
import gui_config # TODO: simplify example to use gui config
...
GUI_SCALE = 400000.0 # Used to change scale of drawing scene -> lat/lon
URL_API = "https://beta-caladan.polymathrobotics.dev/api/"
...
def main():
    ...
    window = create_window(GUI_SCALE)
